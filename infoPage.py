...
class infoPage(Screen):
	...
	def __init__(self, **kwargs):
		...
		self.logo_text = Label(text= '        Jumpy Kitten\ndeveloped by AOCTdev', bold= True, font_size= font_scaling(20, self.font_scale))
